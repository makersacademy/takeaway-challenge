...
My Approach
-------
I built this program following TDD practices. I took the user stories that were provided and wrote tests for them, the tests then infromed the code that I had written. The tests were written using doubles which allowed me to isolate the tests for each class as well as correctly mocking their behaviour when used in other classes.

I was able to follow an OOD; the program has been separated into classes, each of which fulfilling only a single responsibility. This would make any future changes (such as a different menu) or additional functionality easy to implement as it would have minimal impact on any other area of the program.
