class Order
  ...
  def input
    quantity_to_order = 'test'
    item_to_order = 'test'
    while item_to_order != '' and quantity_to_order !='' do
      puts 'Enter index of dish to order. Then order quantity. Hit enter twice to finish'
