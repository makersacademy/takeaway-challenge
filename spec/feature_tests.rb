...
p moth_saute = Dish.new("Moths Sautéed in Butter", 9.99)
...
jason = Customer.new("Jason", "50 Commercial St, London E1 6LT", "+447522253914")
p jason
puts "*****************************************"
puts "Creating restaurant"
p grub = Restaurant.new(menu)
puts "*****************************************"
puts "New takeaway order"
...
puts "jason.order_item(Moths Sautéed in Butter, 1)"
...
jason.order_item("Moths Sautéed in Butter", 1)
