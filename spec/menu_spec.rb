...
describe Menu do
  ...
  describe '#initialise' do
    it 'should create an empty array to store menu items in' do
      expect(subject.menu_items.is_a? Hash).to eq true
    end
  end

  describe '#add_item' do
    it 'should add a dish to the items array' do
  ...
  describe '#list_dishes' do
    it 'should show a list of dishes' do
      ...
      subject.add_item('Fake Steak(Feak)', 18.50)
      expect(subject.list_dishes).to eq("Fake Steak(Feak)" => 18.5, "Steak" => 18.5,) 
    end
  end
