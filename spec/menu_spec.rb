...
let(:dish) { double(:dish, :name => "Chicken Curry", price: 12.30, available: true ) }
...
PRICE3 = 14.30
  ...
  describe '4 #choose' do
    it '4.1 returns the desired meal' do
      menu.add_dish(NAME, PRICE)
      expect(menu.choose("Chicken Curry")).to eq dish
    end
  end
