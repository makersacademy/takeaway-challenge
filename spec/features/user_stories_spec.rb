...
describe Takeaway do
  ...
  context 'User story 1' do
    ...
    it 'Should have a list of dishes and prices' do
      expect(takeaway.view_menu).to eq ({ :pepperoni => 10, :hawaiian => 12, :meat_feast => 15, :spicy_sauasage => 11,
       :vegetarian => 9 })
    end
  end
  context 'User Story 2' do
    ...
    it 'Should have a defaultorder amount of 1 if no argument given' do
