...
describe "user stories" do
  ...
  it 'so that Kylie can order what she wants, she should be able to select from available dishes' do
    dish = "Beef"
  ...
  it 'so that Marc can verify the order is correct, he should be able to check that total price matches the sum of various dishes' do
    dish = "Chicken"
    menu.select(dish, 1)
