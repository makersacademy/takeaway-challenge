...
describe Restaurant do 
  ...
  describe "#send_confirmation" do 
    ...
    it "sends a confirmatio with date and time" do 
      ...
      expect(subject.confirmation).to eq "Thank you! Your order was placed and will be delivered before 13:21"
    end

    it "Raise an error if you trey to get confirmation without order" do 
      expect { subject.confirmation }.to raise_error "You need to order first"
    end
