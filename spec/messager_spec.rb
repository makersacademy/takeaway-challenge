...
describe Messager do
  ...
  let(:message) {"Hi Sergio, thank you for your order of 3.14€.  Your food will be delivered before #{delivery_time}"}
  let(:content_manager) {double :content_manager, customer: customer, delivery_time: delivery_time, generate_body_msg: message }
