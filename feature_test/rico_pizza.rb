...
second_tasty_thing = rico_pizza.display_menu[10]
third_tasty_thing  = rico_pizza.display_menu[10]

rico_pizza.select(first_tasty_thing  ,5)
rico_pizza.select(second_tasty_thing ,5)
rico_pizza.select(third_tasty_thing  ,5)
